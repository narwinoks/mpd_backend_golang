...
type Employee struct {
	...
	Gender             general.Gender       `gorm:"foreignKey:GenderID;references:ID;->"`
	JobTitle           job.JobTitle         `gorm:"foreignKey:JobTitleID;references:ID;->"`
	EmployeeStatus     job.EmploymentStatus `gorm:"foreignKey:EmploymentStatusID;references:ID;->"`
	Detail             EmployeeDetail       `gorm:"foreignKey:EmployeeID;references:ID;->"`
	Addresses          []EmployeeAddress    `gorm:"foreignKey:EmployeeID;references:ID;->"`
	Educations         []EmployeeEducation  `gorm:"foreignKey:EmployeeID;references:ID;->"`
}
